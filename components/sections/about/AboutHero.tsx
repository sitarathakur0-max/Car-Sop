...
//                 >
//                     <source src="/videos/about car.mp4" type="video/mp4" />
//                 </video>
//                 <div className="absolute inset-0 bg-gradient-to-r from-black/60  to-black/45"></div>
//             </div>
...
//                         <br />Powered by <span className="text-amber-400">Trust</span>
//                     </h1>

//                     <p className="text-gray-300 text-lg max-w-2xl mx-auto">
//                         We are a team of automotive enthusiasts dedicated to providing
//                         the finest luxury car buying experience.
//                     </p>
//                 </motion.div>
//             </div>
//             <motion.button
